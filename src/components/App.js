    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><button data-test-id="menu-item-breakfast" id="filter-btn-1" onClick={getFoodItem}>Breakfast</button></li>
                <li><button  data-test-id="menu-item-lunch" id="filter-btn-2" onClick={getLunchItem}>Lunch</button></li>
                <li><button data-test-id="menu-item-shakes" id="filter-btn-3" onClick={getShakeItem}>Shakes</button></li>
